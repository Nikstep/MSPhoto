...
//Created hidden image without url and attached to overlay.
    image = $("<img/>", { id: "image"}),
...
$(".hamburger").on("click", function () {
    ...
    if ($(".menu").hasClass("isOn")) {
      $(".menu").slideUp(500).removeClass("isOn");
      $(".social").fadeOut(300).removeClass("isOn");
    }
    else {$(".menu").slideDown(500).addClass("isOn");
    $(".social").fadeIn(300).addClass("isOn");}
